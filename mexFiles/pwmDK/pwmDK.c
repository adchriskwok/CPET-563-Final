...
static void mdlOutputs(SimStruct *S, int_T tid){
  ...
  real_T *ch1 = ssGetOutputPortRealSignal(S,1);
  real_T *ch2 = ssGetOutputPortRealSignal(S,2);
  real_T *ch3 = ssGetOutputPortRealSignal(S,3);
  real_T *ch4 = ssGetOutputPortRealSignal(S,4);
